...
var OpenIdConnectModule = /** @class */ (function (_super) {
    ...
    OpenIdConnectModule = __decorate([
        vuexModuleDecorators.Module({ namespaced: true, name: 'openid' })
    ], OpenIdConnectModule);
    ...
    OpenIdConnectInterceptors.buildResponseErrorInterceptorCallback = function (errorVm, store, retryAxiosInstance) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                console.log('LOG 1.3 (Error Message): ', errorVm.message);
                // Only intercept 401 unauthorized calls
                if ((errorVm.message === 'Network Error') || (errorVm.response && errorVm.response.status && errorVm.response.status === 401)) {
